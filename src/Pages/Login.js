...
const Login = () => {
  const { userLoggedIn, redirectPath, setRedirectPath } = useAuth();
  ...
  return (
    <div>
      ...
      <main className="w-full h-screen flex self-center place-content-center place-items-center bg-cows-and-bulls">
        <div className="w-80 sm:w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl primary-white-bg z-0 ">
          <div className="text-center">
            <div className="mt-2">
              <h3 className="primary-brown-text text-xl font-semibold sm:text-2xl">
                Welcome Back
              </h3>
            </div>
          </div>
          ...
          <p className="text-center text-sm primary-dark-text">
          ...
          <div className="flex flex-row text-center w-full">
            ...
            <div className="text-sm font-bold w-fit primary-dark-text">OR</div>
